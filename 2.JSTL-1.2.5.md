...
| Các thẻ định dạng và địa phương hóa (Formatting and Localization Tags) | Những thẻ này cung cấp định dạng cho các con số, ngày tháng và hỗ trợ thông qua miền địa phương (locales) và bó tài nguyên (resource bundles). Để sử dụng JSTL core tags, bạn cần khai báo nó vào trang JSP với cú pháp:  `<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>` |
